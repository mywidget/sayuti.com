...
<?php
	...
	if($sqlcat->num_rows > 0){
		...
		produk
		WHERE pub='Y' and 
		produk.kategori_produk ='$rowcat[id_jenis_produk]' order by produk.status desc, id_produk desc limit $offset, $no_of_records_per_page");
	?>
					...
					<div class="blog_medium clearfix" style="margin-top:7%!important;margin-bottom:20px">
						...
						<?php
							...
							while($row=$sqlp->fetch_array()){
								...
								$seol = '/produk/'.$seo.'/'.$row['produk_seo'];
								...
								// }
							?>
							<li class="list_item col-lg-<?=$col;?> col-md-<?=$col;?> col-sm-<?=$col;?> <?=$row['seo_produk'];?>">
									...
									<figure>
										...
										<div class="touching medium">
											...
											<div class="hovers">
												...
												<a href="<?=$seol;?>" class="hover-link"><i class="fa fa-link"></i></a>
											</div>
										</div>
