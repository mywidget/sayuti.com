                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="padding:20px" valign="top">
                                                                    <h2>Konfirmasi Aktivasi Reseller!</h2>
                                                                    ...
                                                                    <p style="direction:ltr;font-size:14px;line-height:1.4em;color:#444444;font-family:&quot;Helvetica Neue&quot;,Helvetica,Arial,sans-serif;margin:0 0 1em 0;margin:5px 0 10px 0;text-align:center">
                                                                        <a href="https://sayuti.com/login" style="text-decoration:underline;color:#5F8A0F;border-radius:10em;border:1px solid #77D044;text-decoration:none;color:#fff;background-color:#5F8A0F;padding:5px 15px;font-size:16px;line-height:1.4em;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;font-weight:normal" target="_blank">LOGIN AKUN</a>
                                                                    </p>
                                                                </td>
                                                                <td>
                                                                </td>
