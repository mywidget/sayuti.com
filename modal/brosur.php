...
<div class="modal-header p-t-5 p-b-5" style="background-color:<?=$warnabar;?>;color:#fff;">
        <h5 class="modal-title text-white" id="exampleModalLabel">Cetak Brosur</h5>
	  ...
	  <div class="col-md-8 lain">	
        <div class="form-group">
          <div class="input-group">
            ...
            <input type="text" class="form-control" aria-label="" id="biaya" value="<?=biaya(66);?>" readonly>
          </div>
        </div>
      </div>
	 <div class="col-md-4 lain">	
        <div class="form-group">
          <button  type="submit" class="btn btn-success save" disabled><i class="fa fa-save"></i></button>
        </div>
      </div>
	  <div class="col-md-8">	
        <div class="form-group">
