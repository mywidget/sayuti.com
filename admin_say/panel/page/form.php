...
if($GETID > 0) {
$sql = $db->query("SELECT * FROM `page`  WHERE id_page=$GETID");
...
#files {
    ...
    cursor: pointer
		...
		<div class="form-group">
			    <label class="control-label" for="isi">Isi<span class="req"> *</span></label>
			    <div class="controls">
                <textarea id="compose-textarea" rows="3" class="form-control k-textbox" data-role="textarea" required="required" name="isi" data-parsley-errors-container="#errId5"><?=$isi;?></textarea><span id="errId5" class="error"></span></div>
