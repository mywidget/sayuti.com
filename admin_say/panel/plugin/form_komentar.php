...
li{list-style:none}
		...
		<div class="form-group">
			    <label class="control-label">ID Pages Facebook<span class="req"> *</span></label>
			    <div class="controls">
                <input class="form-control"  required="required" name="pages"  type="text" value="<?=$pages;?>">
				</div>
		</div>
		<div class="form-group">
			    <label class="control-label">Alamat Website<span class="req">*</span></label>
			    <div class="controls">
                <input class="form-control"  required="required"  name="site_name" value="<?=$site_name;?>"  type="text"></div>
		</div>
		<div class="form-group">
			    <label class="control-label">ID App<span class="req">*</span></label>
			    <div class="controls">
                <input class="form-control"  required="required"  name="app_id" value="<?=$app_id;?>"  type="text"></div>
		</div>
                                        <div class="form-group"> 
                                             <label>Publish</label>
                                            <div class="">
