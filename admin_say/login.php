  ...
  <body class="login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <p class="login-box-msg">Panel Login pengguna</p>
	...
	<script type="text/javascript" src="plugins/validation.min.js"></script>
	<script type="text/javascript" src="plugins/script-log.js"></script>
    <script>
      $(function () {
        $('input').iCheck({
